...
def set_args():
    ...
    arg_parser.add_argument('-l', '--loglev', type = str, default = logging.getLevelName(DEFAULT_LOG_LEVEL),
...
if __name__ == '__main__':
    ...
    lgr = get_simple_logger(f"simple_{get_base_filename(__file__)}", file_handling = False)
    code = 0
    try:
